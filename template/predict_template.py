...
with open('../example_demo/best_estimator', 'rb') as f:
    estimator = pickle.load(f)
with open('../example_demo/demo_test_data', 'rb') as f1:
...
with open('../example_demo/demo_train_data', 'rb') as f2:
...
densx_predict = optimizer.run(densx_init, Vx_true, mu, N)

## plot results
plot_prediction(Ek_test, Ek_predict, dEkx_test, dEkx_predict, densx_true, densx_predict, densx_init)
