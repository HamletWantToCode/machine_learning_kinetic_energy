...
ax1.yaxis.set_major_formatter(funcfmt)
ax1.set_xlabel('distance')
ax1.set_ylabel('fraction')

dens_num1 = dens[data[:, 0]==1]

mean = np.mean(dens_num1, axis=0)
Cov = (dens_num1 - mean).T @ (dens_num1 - mean) / n
U, S, _ = np.linalg.svd(Cov)
dens_Xt = (dens_num1 - mean) @ U
